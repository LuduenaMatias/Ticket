<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-2">
                <img src="./img/settings.png" alt="Image" class="img-responsive animated flipInY">
            </div>
            <div class="col-sm-10">
                <br><br>
              <p class="lead text-info">Bienvenido Administrador, en esta página se muestran todos los usuarios y administradores registrados hasta la fecha.<br>
               Una cuenta con nivel <strong>Administrador</strong> es capaz de eliminar usuarios registrados. </p>
            </div>
          </div>
        </div>
...
?>
    <div class="container">
        <div class="row">
            ...
            <img src="img/robot.png" alt="Image" class="img-responsive"/><br>
                
            </div>
            <div class="col-sm-7 animated flip">
                <h1 class="text-danger">Lo sentimos esta página es solamente para Administradores de Conectores Rosario</h1>
