    ...
    if(isset($_POST['nom_admin_reg']) && isset($_POST['admin_reg']) && isset($_POST['admin_clave_reg'])){
       ...
       /* Actualizar cuenta admin */
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-3">
              <img src="./img/admin.jpg" alt="Image" class="img-responsive" width="70%">
            </div>
            <br><br><br>
            <div class="col-sm-9">
                      ...
                      <div class="col-sm-12">
                        <div class="panel panel-danger">
                          ...
                          <div class="panel-body text-center">
                              <br>
                              <img class="rounded mx-auto d-block" src="./img/borrar.png" width="25%">
                              <br><br>
                              <button class="btn btn-danger btn-sm" data-toggle="modal" data-target=".bs-example-modal-sm">Eliminar cuenta</button>
