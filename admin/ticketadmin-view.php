<?php if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){ ?>
        <div class="container">
          <div class="row">
            <div class="col-sm-2">
              <img src="./img/mensaje.png" alt="Image" class="img-responsive animated tada" width="85%">
            </div>
            <div class="col-sm-10">
                <br><br>
              <p class="lead text-info">Bienvenido administrador, aqui se muestran todos los Tickets de Conectores Rosario los cuales podra eliminar, modificar.</p>
            </div>
          </div>
