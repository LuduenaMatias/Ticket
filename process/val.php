...
if(mysqli_num_rows($sql)>0){
    ...
    echo '<label class="control-label" for="inputSuccess2" style="margin-top:10px;";>Un usuario con este nombre ya existe, por favor elige otro nombre de usuario</label>';
}else{
