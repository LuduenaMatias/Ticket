<?php if(!$_SESSION['nombre']==""&&!$_SESSION['tipo']==""){ 
        ...
        <div class="container">
          <div class="row well">
            <div class="col-sm-3">
              <img src="img/config2.png" alt="Image" class="img-responsive" width="200" height="200">
            </div>
            <div class="col-sm-9 lead">
              <h2 class="text-info">Bienvenido a la configuración de su cuenta en Conectores Rosario.</h2>
              <p>Puedes <strong>actualizar los datos</strong> de tu cuenta ó puedes 
              <strong>eliminar tu cuenta</strong> permanentemente si ya no deseas ser usuario de Conectores Rosario</p>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-4 text-center well">
              ...
              <img src="img/borrar.png" alt="Image" width="160" height="160"><br><br><br>
