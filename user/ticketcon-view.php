...
?>
        <div class="container">
            <div class="row well">
            <div class="col-sm-2">
                <img src="img/relog.jpg" class="img-responsive" alt="Image">
            </div>
                      ...
                      <div class="panel-body">
                          <div class="container">
                              <div class="col-sm-12">
                                  <div class="row">
                                      <div class="col-sm-4">
                                          <img class="img-responsive" alt="Image" src="img/ticketicon.jpg" width="250" height="250">
                                      </div>
                                      <div class="col-sm-8">
                                          <div class="row">
        ...
        <div class="container">
            <div class="row  animated fadeInDownBig">
                ...
                <div class="col-sm-7 text-center">
                    <h1 class="text-danger">Lo sentimos ha ocurrido un error al realizar la consulta, esto se puede deber a lo siguiente:</h1>
