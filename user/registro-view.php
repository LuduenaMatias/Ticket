<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $asunto="Registro de cuenta en Conectores Rosario";
        $cabecera="From: Conectores Rosario Argentina<conectoresrosario@CRShop.com>";
        $mensaje_mail="Hola ".$nombre_reg.", Gracias por registrarte en Conectores Rosario. Los datos de cuenta son los siguientes:\nNombre Completo: ".$nombre_reg."\nNombre de usuario: ".$user_reg."\nClave: ".$clave_reg2."\nEmail: ".$email_reg;
        ...
        if(MysqlQuery::Guardar("cliente", "nombre_completo, nombre_usuario, email_cliente, clave", "'$nombre_reg', '$user_reg', '$email_reg', '$clave_reg'")){
            ...
            echo '
                <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        Cuenta creada exitosamente, ahora puedes iniciar sesión, ya eres usuario de Conectores Rosario.
                    </p>
                </div>
            ';
        }else{
...
<div class="container">
  <div class="row">
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" name="clave_reg" placeholder="Ingrese una Contraseña" required="">
            </div>
            <div class="form-group">
              <label><i class="fa fa-envelope"></i>&nbsp;Email</label>
              <input type="email" class="form-control"  name="email_reg"  placeholder="Ingrese su email" required="">
            </div>
    ...
    <div class="col-sm-4 text-center hidden-xs">
      <img src="img/electricidad.jpg" class="img-responsive" alt="Image">
      <h2 class="text-primary">Bienvenido a nuestra plataforma !</h2>
    </div>
