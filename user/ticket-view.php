<?php if(isset($_SESSION['nombre']) && isset($_SESSION['tipo'])){
        ...
        if(isset($_POST['fecha_ticket']) && isset($_POST['name_ticket']) && isset($_POST['email_ticket'])){
          ...
          $cabecera="From: Conectores Rosario<conectoresrosario@CRShop.com>";
        ...
        <div class="container">
          <div class="row well">
            ...
            <div class="col-sm-9 lead">
              <h2 class="text-info">¿Cómo crear un nuevo Ticket?</h2>
              <p>Para crear un nuevo ticket deberá llenar todos los
                 campos de el siguiente formulario. Usted podra verificar 
                 el estado de su ticket mediante el <strong>Ticket ID</strong> que
                 se le proporcionara a usted cuando llene y nos envie el formulario.</p>
            </div>
          </div>
          <!--fin row 1-->
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-sm-4 text-center">
                      <br><br><br>
                      <img src="img/mensajes.png" width="320" height="210" alt=""><br><br>
                      <p class="text-primary text-justify">
                        Por favor llene todos los datos de este formulario
                        para crear su nuevo ticket. El <strong>Ticket ID</strong> será
                        enviado a la dirección de correo electronico proporcionada en este formulario.</p>
                    </div>
                    <div class="col-sm-8">
                      <form class="form-horizontal" role="form" action="" method="POST">
                        ...
                        <div class="form-group">
                          <label  class="col-sm-2 control-label">Problema sobre su producto</label>
                          <div class="col-sm-10">
                        ...
                        <div class="form-group">
                          <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-info">Crear nuevo ticket</button>
                          </div>
                        </div>
                             </fieldset> 
                      </form>
...
?>
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <img src="./img/desconect.png" alt="Image" class="img-responsive rounded"/><br>
                <img src="./img/robot.png" alt="Image" class="img-responsive"/>
                
            </div>
            <div class="col-sm-7 text-center">
              <br><br><br><br><br><br><br>
                <h1 class="text-danger">Lo sentimos, pero esta funcion es unicamente para usuarios de nuestra plataforma.</h1>
                <h3 class="text-info">Inicia sesión para poder acceder a esta funcion.</h3>
            </div>
